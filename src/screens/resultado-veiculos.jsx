...
const ResultadoVeiculos = () => {
  ...
  return <div className="view rv-page">
    <div className="rv-head"><div><h1>Resultado por Veículo</h1><p>Receitas dos CT-es e custos do contas a pagar, pelo vencimento e rateados por veículo.</p></div><button className="btn" onClick={apply}><Icon name="refresh"/> Atualizar</button></div>
